 ...
 */
abstract class UserDetailsAwareConfigurator<U extends UserDetailsService> extends SecurityConfiguratorAdapter<AuthenticationManager,AuthenticationManagerBuilder> {
     ...
     */
    protected abstract U getUserDetailsService();
}
